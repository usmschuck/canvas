...
describe AccountsController do
  ...
  describe "add_account_user" do
    ...
    it "should allow adding an existing user to a sub account" do
      ...
      @munda = user_with_pseudonym(:account => @account, :active_all => 1, :username => 'munda@usms.com')
      post 'add_account_user', :account_id => @subaccount.id, :membership_type => 'AccountAdmin', :user_list => 'munda@usms.com'
      response.should be_success
